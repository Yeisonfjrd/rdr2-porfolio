...
export type PortfolioInitialSection = 'portfolio' | 'activities' // 'audio' eliminado
...
const menuItems = [
  ...
  },
  {
    id: 'activities',
    label: 'ACTIVITIES',
    description: 'Métricas en vivo: actividad de GitHub y tiempo de código con WakaTime.',
    ...
    <div className="rdr-cinematic-bars absolute inset-0 overflow-hidden" style={{ background: '#0d0b08' }}>
      ...
      <div className="relative flex flex-col h-full px-8 md:px-[8vw] py-[14vh]" style={{ zIndex: 30 }}>
        ...
        <div className="mb-8 w-full">
          <h1
            className="font-chinese-rocks uppercase tracking-[0.1em] text-[#e8dfc0]"
        ...
        {/* 3 columnas en lugar de 4 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-1 w-full max-w-5xl mx-auto items-start mt-4">
            ...
            return (
              ...
              >
                ...
                <div className="mt-5 px-1">
                  <h2
                    className="font-chinese-rocks uppercase tracking-[0.08em] transition-colors duration-200"
                    style={{
